...
import { DonationCard } from "component";
            ...
            <div className="container">
                <div className="donation__content row">
                    <div className="col-lg-8 col-md-12 donation__text">
                        ...
                        <p>
                            <strong>*Lưu ý:</strong> nhóm không dùng zalo và <strong>KHÔNG BAO GIỜ</strong> yêu cầu Mạnh Thường Quân cung cấp thông tin thẻ hoặc mã OTP
                        </p>
                        <p className="donation__list">
                            ...
                            <ul>
                                ...
                                <li>--------------</li>
                                 <li> Tài khoản nhận quyên góp của nhóm. Chi phí sẽ được chia đều cho các bé khác còn nằm viện và gây dựng nhà chung.</li>
                    ...
                    <Link to={ROUTER.USER.CONTACT} className="primary-btn">Ủng Hộ Ngay</Link>
                    </div>
                        </p>
                    </div>
                </div>
